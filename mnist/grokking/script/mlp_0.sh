...
python train_mnist_mlp.py --wandb_run mlp_d12_w400_tp2000_scale8_wd002 --depth 12 --width 400 --train_points 2000 --optimization_steps 100000 --initialization_scale 8.0 --rank --probe --weight_decay 0.02 --device cuda:0
python train_mnist_mlp.py --wandb_run mlp_d12_w400_tp2000_scale8_wd0015 --depth 12 --width 400 --train_points 2000 --optimization_steps 100000 --initialization_scale 8.0 --rank --probe --weight_decay 0.015 --device cuda:0
python train_mnist_mlp.py --wandb_run mlp_d4_w400_tp2000_scale8_wd002 --depth 4 --width 400 --train_points 2000 --optimization_steps 100000 --initialization_scale 8.0 --rank --probe --weight_decay 0.02 --device cuda:0
python train_mnist_mlp.py --wandb_run mlp_d4_w400_tp2000_scale8_wd0015 --depth 4 --width 400 --train_points 2000 --optimization_steps 100000 --initialization_scale 8.0 --rank --probe --weight_decay 0.015 --device cuda:0# python train_mnist_mlp.py --wandb_run mlp_d12_w400_tp2000_scale8_wd0005 --depth 12 --width 400 --train_points 2000 --optimization_steps 100000 --initialization_scale 8.0 --rank --probe --weight_decay 0.005 --device cuda:0
# python train_mnist_mlp.py --wandb_run mlp_d12_w400_tp2000_scale8_wd01 --depth 12 --width 400 --train_points 2000 --optimization_steps 100000 --initialization_scale 8.0 --rank --probe --weight_decay 0.1 --device cuda:0
